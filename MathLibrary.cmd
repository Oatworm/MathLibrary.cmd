...
:ExtDivision
	...
	:ExtDivisionLoop
		...
		IF NOT DEFINED _DivCol (
			CALL :ExtCompare %_DivCoef% 0 _DivCoefComp
		...
		FOR /L %%H IN (9,-1,1) DO (
			CALL :ExtCompare !_DivD_%%H! %_DivCoef% _DivInComp
...
:ExtSubtract
	...
	CALL :ExtDim %_SubtractM% _SubtractLen _SubtractDec
...
:ExtMatchPad
	...
	SET _MatchPad1=!%1!
	SET _MatchPad2=!%2!
	CALL :ExtDim %_MatchPad1% _MatchPadL1 _MatchPadD1
	CALL :ExtDim %_MatchPad2% _MatchPadL2 _MatchPadD2
	...
	ENDLOCAL & SET %1=%_MatchPad1%& SET %2=%_MatchPad2%
GOTO :EOF
